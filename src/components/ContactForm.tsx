  ...
  const socialLinks = [
    {
      name: 'Facebook',
      href: '#facebook',
      gradient: 'from-[#1877F2] to-[#0C5BD9]',
      icon: (
        <svg
          aria-hidden="true"
          focusable="false"
    ...
    },
    {
      name: 'X',
      href: '#x',
      gradient: 'from-[#000000] via-[#0A0A0A] to-[#1E1E1E]',
      icon: (
        <svg
          aria-hidden="true"
          focusable="false"
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className={`inline-flex items-center gap-2 rounded-xl bg-gradient-to-r ${social.gradient} px-4 py-2 text-sm font-semibold text-white shadow-sm transition-transform hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background`}
                >
                  {social.icon}
